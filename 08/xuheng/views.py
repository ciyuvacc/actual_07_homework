...
app = Flask(__name__)
app.secret_key = r'\xd2\xecj\x8b[\xfb\xb7\x82 7\xe8\xa6\xbe\x04\xaa\xceId\x06)py=+8\xc2\x85\xd6)\x99\xe1p'
...
def consume_time(func):
    ...
    def wapper(*args, **kwargs):
        ...
        etime = time.clock()
        logger.debug('view %s, consume time:%s', func.__name__, etime - stime)
        return rtn
    return wapper
